...
func (x *CreateResponse) GetGameId() uint32 {
...
type CreateResponse_GameId struct {
	GameId uint32 `protobuf:"varint,4,opt,name=game_id,json=gameId,proto3,oneof"`
}
...
func (x *JoinRequest) GetGameId() uint32 {
...
type JoinRequest_GameId struct {
	GameId uint32 `protobuf:"varint,3,opt,name=game_id,json=gameId,proto3,oneof"`
}
...
var file_network_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x22, 0xa0, 0x01,
	...
	0x04, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x06, 0x67, 0x61, 0x6d, 0x65, 0x49, 0x64, 0x12,
	...
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x06, 0x67, 0x61, 0x6d,
