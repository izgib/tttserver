...
func (c *gameConfiguratorClient) GetListOfGames(ctx context.Context, in *flatbuffers.Builder,
	opts ...grpc.CallOption) (GameConfigurator_GetListOfGamesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_GameConfigurator_serviceDesc.Streams[0], c.cc, "/transport.GameConfigurator/GetListOfGames", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gameConfiguratorClient) CreateGame(ctx context.Context,
	opts ...grpc.CallOption) (GameConfigurator_CreateGameClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_GameConfigurator_serviceDesc.Streams[1], c.cc, "/transport.GameConfigurator/CreateGame", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *gameConfiguratorClient) JoinGame(ctx context.Context,
	opts ...grpc.CallOption) (GameConfigurator_JoinGameClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_GameConfigurator_serviceDesc.Streams[2], c.cc, "/transport.GameConfigurator/JoinGame", opts...)
	if err != nil {
		return nil, err
	}
